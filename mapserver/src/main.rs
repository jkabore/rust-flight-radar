...
fn main() {
    ...
    let listener = TcpListener::bind("localhost:3000").expect("Unable to bind to address 3000");
    println!("Server running on port 3000...\n");
    let threat_pool = ThreadPool::new(5);
...
fn process_stream(
    ...
    if test != "GET / " {
        println!("Request {:#?} ignored totally:", http_request[0]);
        return;
    }
